import {readFileSync} from 'node:fs';const data=JSON.parse(readFileSync('data/radar.json','utf8')) as {signals:{date:string}[]};import {test,expect} from '@playwright/test';import AxeBuilder from '@axe-core/playwright';
